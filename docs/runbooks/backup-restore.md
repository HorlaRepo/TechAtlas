...
TECHATLAS_RELEASE_ENV_FILE=/etc/techatlas/release.env \
...
`release.env` is generated by the production workflow and pins the backend and backup images used
for the rehearsal. Do not substitute floating image tags.
