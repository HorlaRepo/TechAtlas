...
function responseFor(path: string, search: URLSearchParams, method: string): unknown {
  ...
  if (path === "/api/v1/public/search/domains") return { results: [{ ...domain, technology_slugs: ["nextjs"], category_slugs: ["framework"], updated_at: timestamp }], facets: { technology: { nextjs: 1 }, category: { framework: 1 }, country: { US: 1 } }, estimated_total_hits: 1, limit: 20, offset: 0, query_at: timestamp };
